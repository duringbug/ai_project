 ...
 * @LastEditors: ${author}
 * @LastEditTime: 2023-09-26 21:38:45
-->
# 逻辑回归
...
## 特征向量优化
词汇表: $V = {w_1, w_2, \ldots, w_M} \text{(训练集中的词汇)}$ <br/>
词袋向量矩阵: $D_{N*M} \text{, 大小为 } N_{训练or测试} \times M$ <br/>
词频矩阵: $A_{M*10} ,\text{ 大小为 } M \times 10$ <br/>
熵矩阵: $H_{M*1},\text{ 大小为 } M \times 1$ <br/>
满足公式:
